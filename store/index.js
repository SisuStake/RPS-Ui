...
export const state = () => ({
    walletAddress: '', //Represents our wallet address
    walletErrors: '',  //Represents any errors associated with the wallet
    loading: false, //Represents the loading indicator. Its false because it indicates that there are no ongoing loading activity
    secretJS: null, //Represents the SecretJS object or instance
    walletIsConnecting: false, //Represent the connection of the wallet
